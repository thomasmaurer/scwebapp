 ...
 *
 * Trimmed to ~14 high-signal items for a faster assessment.
 * Combined with FlowEngine's adaptive cap (≤ 10 answers), users see
 * results sooner. NPC gates (23, 24, 25) are kept as conditional cards
 * that only fire when geo = EU.
 *
 * Each entry:
...
const STATEMENTS = [
  ...
  // ── Encryption & Key Management ─────────────
  {
    ...
    context: "Your organization controls the keys — including hardware-backed and confidential computing options where keys never leave your premises.",
    weight: 2,
  ...
  },
  {
    id: 16,
    category: "Workload Sensitivity",
    statement: "We process highly regulated data (financial services or healthcare)",
    context: "Banking, trading, insurance, patient records, or medical data under strict national regulation.",
    weight: 2,
  ...
  // ── Cloud Strategy ──────────────────────────
  {
    ...
    context: "Strategic commitment to Azure for innovation and digital transformation, prioritizing managed operations over self-managed infrastructure.",
    weight: 2,
  ...
  },
  {
    id: 27,
    category: "Cloud Strategy",
    statement: "Access to the broadest set of cloud services (AI, Analytics, IoT) with elastic global scale is important",
    context: "200+ services and burst capacity vs. a curated subset with tighter controls.",
    weight: 2,
